...
(Note: 2022-08-03 - this repo has been restored from archive.org, as the original repo and owner disappeared from github. I'm not the original author!)
...
* [Creating a 2D vertical shoot 'em up](https://www.parallelrealities.co.uk/tutorials/#shooter2)
* [Creating a 2D run and gun game](https://www.parallelrealities.co.uk/tutorials/#gunner)
* [Creating a roguelike](https://www.parallelrealities.co.uk/tutorials/#rogue)
* [Creating an in-game achievement system](https://www.parallelrealities.co.uk/tutorials/#medals)
* [Creating a simple 2D turn-based strategy game](https://www.parallelrealities.co.uk/tutorials/#tbs)
* [Making a 2D isometric game](https://www.parallelrealities.co.uk/tutorials/#isometric)
